...
export const metadata: Metadata = {
  title: "Luminose | Premium Skincare with Plant-Based Ingredients",  description: "Transform your skin with Luminose's clinically-tested, botanical skincare collection. Natural, sustainable beauty products for radiant, healthy complexion.",  keywords: "skincare, botanical skincare, natural beauty, organic skincare, premium skincare, plant-based",  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Luminose Skincare",    description: "Pure science meets botanical wellness. Discover our award-winning skincare collection.",    type: "website",    siteName: "Luminose",    images: [{
      url: "http://img.b2bpic.net/free-photo/top-view-tropical-leaves-vibrant-background-summer-flat-lay-composition_1182-2695.jpg",      alt: "Luminose skincare collection"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "Luminose | Premium Skincare",    description: "Elevate your skincare ritual with clinically-formulated, plant-based products.",    images: ["http://img.b2bpic.net/free-photo/top-view-tropical-leaves-vibrant-background-summer-flat-lay-composition_1182-2695.jpg"]
  }
};
